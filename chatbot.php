...
if ($chat_id != $Manager) {
    ...
    if ($text == "/start") {
        ...
        $reply = "Assalom Alaykum <b>" . $full_name . "</b>, " . $compane . " Saydullo Xaydarov shaxsiy botiga hush kelibsiz !\nMurojat Yo'llashingiz Mumkin 👇";
        bot('sendmessage', [ 
            'chat_id' => $chat_id, 
            'text' => $reply, 
            'parse_mode' => "HTML", 
        ...
        $reply = "Yana bir inson siz bilan gaplashmoqchi:\n" . $full_name . "\n👉 👉 <a href='tg://user?id=" . $from_id . "'>" . $from_id . "</a>\n" . date('Y-m-d H:i:s') . "";
        bot('sendmessage', [ 
            'chat_id' => $Manager, 
            'text' => $reply, 
            'parse_mode' => "HTML", 
